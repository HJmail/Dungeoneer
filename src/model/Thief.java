...
public class Thief extends Hero {
  ...
  public String specialSkill(DungeonCharacter opponent) {
    ...
    if (roll <= 0.4) {
      ...
      return myName + " performs a SURPRISE ATTACK for " 
        + damage1 + " damage and gets an EXTRA attack for " + damage2 + " damage!";
    }
    ...
    return myName + "'s surprise attack turns +"
       + " into a normal attack for " + normalDamage + " damage!";
  }
